...
HD_PWD='C:/Users/M/Desktop/projects/Main_Project_v5/Main_Project_v5.runs/MainDesign_xlconstant_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainDesign_xlconstant_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainDesign_xlconstant_0_1.tcl
