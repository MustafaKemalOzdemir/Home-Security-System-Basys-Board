...
HD_PWD='C:/Users/M/Desktop/projects/Main_Project_v5/Main_Project_v5.runs/MainDesign_xup_clk_divider_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainDesign_xup_clk_divider_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainDesign_xup_clk_divider_1_0.tcl
